...
class CtrVenta {
    ...
    function __construct() {
        ...
        require 'entidad/EntVenta.php';
        require 'interfaz/IntVenta.php';
        require 'dao/DaoVenta.php';
        $this->model = new EntVenta();
    ...
    public function view($uid = null) {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if (isset($_POST['action'])) { // PETICIONES USANDO AJAX           
                ...
                switch ($frm->action) {
                    case 'nuevo':
                        $this->model = new EntVenta(0, $frm->idusu, $frm->idart, $frm->cuent, $frm->banc, $frm->tip, $frm->cant, $frm->prec, 'NOW()');
