                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col col-xs-6">
                                <form method="GET" action="marca.php">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="q" placeholder="Buscar Marcas" value="<?= $q ?>">
                            ...
                            <div class="col col-xs-6 text-right">
                                <div class="btn-group">
                                    <a class="btn btn-success" href="marca.php?action=nuevo&id=0">
                                        ...
                                        <td align="center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a rel="action" data-json='{"entidad":"marca","action":"editar","id":"<?= $marca->id ?>"}'>
                                                            <i class="glyphicon glyphicon-edit"></i> Editar
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a rel="action" data-json='{"entidad":"marca","action":"eliminar","id":"<?= $marca->id ?>"}'>
