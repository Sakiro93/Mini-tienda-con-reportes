                                ...
                                <div class="panel-body">                 
                                    <form id="model-frm" class="form-horizontal">
                                        <div class="row-fluid">  
                                            ...
                                            <input type="hidden" name="id" value="<?= $this->model->idusuario ?>">  
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-xs-7">
                                                    <input required="required"  name="username" type="text" class="form-control" required placeholder="Ingrese Username" value="<?= $this->model->username ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-7">
                                                    <input required="required" id="pass" name="pass" type="text" class="form-control" required placeholder="Ingrese Password" value="<?= $this->model->pass ?>">
                                                ...
                                                <div class="col-xs-6 text-center">
                                                    ...
                                                    <option>Seleccione Rol...</option>
                                                        <?php foreach ($roles as $rol):?>
                                                            ...
                                                            <?= (explode("|", $this->model->idrol)[0] == $rol->idrol ? "selected" : "") ?>>
                                        ...
                                        <div class="row-fluid">
                                            <div class="form-group">
                                                <div class="col col-xs-9 col-xs-offset-2">
                                                    ...
                                                    <button type="reset" onClick="window.location ='user.php'" class="btn btn-danger">
